...
<button href="#" class="popover">Bekijk voorbeeld</button>
<li data-selection="accessories" class="builder-step first-load">
	<section class="cd-step-content">
		...
		<ul class="accessories-list options-list">
			<li class="js-option selected no-highlight" data-price="0">
				<p>Lengte</p>
				<span class="price textfield">
					<input type="text" placeholder="Lengte in mm" id="product-length">
				</span>
			...
			<li class="js-option selected no-highlight" data-price="0">
				<p>Breedte</p>
				<span class="price textfield">
					<input type="text" placeholder="Breedte in mm" id="product-width">
				</span>
			</li>
